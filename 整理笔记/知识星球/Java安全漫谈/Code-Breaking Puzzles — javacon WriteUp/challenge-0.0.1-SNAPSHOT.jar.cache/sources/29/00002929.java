...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/thymeleaf-3.0.11.RELEASE.jar:org/thymeleaf/standard/expression/LessOrEqualToExpression.class */
public final class LessOrEqualToExpression extends GreaterLesserExpression {
    ...
    public static Object executeLessOrEqualTo(IExpressionContext context, LessOrEqualToExpression expression, StandardExpressionExecutionContext expContext) {
        Boolean result;
        ...
        if (leftNumberValue != null && rightNumberValue != null) {
            ...
            throw new TemplateProcessingException("Cannot execute LESS OR EQUAL TO from Expression \"" + expression.getStringRepresentation() + "\". Left is \"" + leftValue2 + "\", right is \"" + rightValue2 + "\"");
        }
        if (logger.isTraceEnabled()) {
            logger.trace("[THYMELEAF][{}] Evaluating LESS OR EQUAL TO expression: \"{}\". Left is \"{}\", right is \"{}\". Result is \"{}\"", TemplateEngine.threadIndex(), expression.getStringRepresentation(), leftValue2, rightValue2, result);
        }
        return result;
    }
}