...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/cglib/core/EmitUtils.class */
public class EmitUtils {
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/cglib/core/EmitUtils$ParameterTyper.class */
    ...
    static int[] getSwitchKeys(Map buckets) {
        ...
        int index = 0;
        for (Integer num : buckets.keySet()) {
            int i = index;
            index++;
            keys[i] = num.intValue();
        }
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/cglib/core/EmitUtils$ArrayDelimiters.class */
