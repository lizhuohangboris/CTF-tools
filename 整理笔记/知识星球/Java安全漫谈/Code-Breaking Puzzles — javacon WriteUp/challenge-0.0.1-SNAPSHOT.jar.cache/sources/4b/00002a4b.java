...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/unbescape-1.1.6.RELEASE.jar:org/unbescape/properties/PropertiesValueEscapeLevel.class */
public enum PropertiesValueEscapeLevel {
    ...
    PropertiesValueEscapeLevel(int escapeLevel) {
