...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/cglib/beans/BeanMapEmitter.class */
class BeanMapEmitter extends ClassEmitter {
    ...
    public BeanMapEmitter(ClassVisitor v, String className, Class type, int require) {
        super(v);
        begin_class(46, 1, className, BEAN_MAP, null, Constants.SOURCE_FILE);
