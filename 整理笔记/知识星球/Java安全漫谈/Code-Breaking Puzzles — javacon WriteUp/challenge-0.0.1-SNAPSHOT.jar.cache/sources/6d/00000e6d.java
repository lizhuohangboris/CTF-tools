...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/attoparser-2.0.5.RELEASE.jar:org/attoparser/ParsingMarkupUtil.class */
final class ParsingMarkupUtil {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int findNextStructureEndDontAvoidQuotes(char[] text, int offset, int maxi, int[] locator) {
        int colIndex = offset;
        int i = offset;
        int n = maxi - offset;
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int findNextStructureStart(char[] text, int offset, int maxi, int[] locator) {
        int colIndex = offset;
        int i = offset;
        int n = maxi - offset;
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int findCharacterSequence(char[] text, int offset, int maxi, int[] locator, char[] charSeq) {
        ...
        while (true) {
            ...
            if (i2 != 0) {
                ...
                if (c == c1) {
                    int j = 1;
                    while (j < charSeq.length && i + j < maxi && text[i + j] == charSeq[j]) {
                        j++;
                    }
                    if (j >= charSeq.length) {
                        return i;
