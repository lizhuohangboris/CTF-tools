...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/hibernate-validator-6.0.13.Final.jar:org/hibernate/validator/internal/util/TypeVariables.class */
public class TypeVariables {
    ...
    public static String getTypeParameterName(Class<?> clazz, int typeParameterIndex) {
        if (typeParameterIndex >= clazz.getTypeParameters().length) {
            throw LOG.getUnableToFindTypeParameterInClass(clazz, Integer.valueOf(typeParameterIndex));
        }
    ...
    public static Type getContainerElementType(Type type, TypeVariable<?> typeParameter) {
        if (type instanceof ParameterizedType) {
            ...
            return typeArguments[getTypeParameterIndex(typeParameter).intValue()];
