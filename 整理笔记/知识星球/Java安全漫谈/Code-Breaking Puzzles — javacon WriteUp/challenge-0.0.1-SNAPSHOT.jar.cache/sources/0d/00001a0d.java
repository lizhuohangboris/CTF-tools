...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:org/springframework/boot/loader/jar/JarURLConnection.class */
public final class JarURLConnection extends java.net.JarURLConnection {
    ...
    public InputStream getInputStream() throws IOException {
        ...
        if (this.jarEntryName.isEmpty()) {
            inputStream = this.jarFile.getData().getInputStream();
        } else {
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:org/springframework/boot/loader/jar/JarURLConnection$JarEntryName.class */
    public static class JarEntryName {
        ...
        private void write(String source, ByteArrayOutputStream outputStream) {
            ...
            while (i < length) {
                ...
                if (c > 127) {
                    try {
                        String encoded = URLEncoder.encode(String.valueOf((char) c), UriEscape.DEFAULT_ENCODING);
