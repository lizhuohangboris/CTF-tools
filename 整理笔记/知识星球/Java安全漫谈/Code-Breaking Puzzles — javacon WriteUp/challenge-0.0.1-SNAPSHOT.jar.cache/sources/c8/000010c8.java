...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/hibernate-validator-6.0.13.Final.jar:org/hibernate/validator/internal/engine/valueextraction/LongArrayValueExtractor.class */
class LongArrayValueExtractor implements ValueExtractor<long[]> {
    ...
    public void extractValues(long[] originalValue, ValueExtractor.ValueReceiver receiver) {
        for (int i = 0; i < originalValue.length; i++) {
            receiver.indexedValue(NodeImpl.ITERABLE_ELEMENT_NODE_NAME, i, Long.valueOf(originalValue[i]));
        }
    }
}