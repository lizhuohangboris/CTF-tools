...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/cglib/beans/BulkBeanEmitter.class */
class BulkBeanEmitter extends ClassEmitter {
    ...
    public BulkBeanEmitter(ClassVisitor v, String className, Class target, String[] getterNames, String[] setterNames, Class[] types) {
        ...
        begin_class(46, 1, className, BULK_BEAN, null, Constants.SOURCE_FILE);
