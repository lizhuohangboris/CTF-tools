...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.1.0.RELEASE.jar:org/springframework/boot/convert/DurationStyle.class */
public enum DurationStyle {
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.1.0.RELEASE.jar:org/springframework/boot/convert/DurationStyle$Unit.class */
    enum Unit {
        ...
        public Duration parse(String value) {
            return Duration.of(Long.valueOf(value).longValue(), this.chronoUnit);
        }
