...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/util/MethodInvoker.class */
    ...
    public Method findMatchingMethod() {
        ...
        for (Method candidate : candidates) {
            if (candidate.getName().equals(targetMethod)) {
                ...
                if (paramTypes.length == argCount && (typeDiffWeight = getTypeDifferenceWeight(paramTypes, arguments)) < minTypeDiffWeight) {
        ...
        for (int i = 0; i < paramTypes.length; i++) {
            ...
            if (args[i] != null) {
                ...
                while (true) {
                    ...
                    if (superClass == null) {
                        break;
                    } else if (paramType.equals(superClass)) {
                        result += 2;
                        superclass = null;
