...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/unbescape-1.1.6.RELEASE.jar:org/unbescape/properties/PropertiesValueEscapeUtil.class */
final class PropertiesValueEscapeUtil {
    ...
    public static String escape(String text, PropertiesValueEscapeLevel escapeLevel) {
        char sec;
        if (text == null) {
            return null;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void escape(Reader reader, Writer writer, PropertiesValueEscapeLevel escapeLevel) throws IOException {
        char sec;
        if (reader == null) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void escape(char[] text, int offset, int len, Writer writer, PropertiesValueEscapeLevel escapeLevel) throws IOException {
        char sec;
