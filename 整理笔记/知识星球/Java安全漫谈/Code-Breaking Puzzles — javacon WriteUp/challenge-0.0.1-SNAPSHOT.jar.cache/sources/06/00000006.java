...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/PatternLayout.class */
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        defaultConverterMap.put(SpringInputGeneralFieldTagProcessor.DATE_INPUT_TYPE_ATTR_VALUE, DateConverter.class.getName());
        ...
        defaultConverterMap.put(ConstraintHelper.MESSAGE, MessageConverter.class.getName());
        ...
        defaultConverterMap.put(SimpleMappingExceptionResolver.DEFAULT_EXCEPTION_ATTRIBUTE, ThrowableProxyConverter.class.getName());
        ...
        defaultConverterMap.put(BeanDefinitionParserDelegate.PROPERTY_ELEMENT, PropertyConverter.class.getName());
