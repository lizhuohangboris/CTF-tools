...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/unbescape-1.1.6.RELEASE.jar:org/unbescape/html/Html5EscapeSymbolsInitializer.class */
final class Html5EscapeSymbolsInitializer {
    ...
    public static HtmlEscapeSymbols initializeHtml5() {
        ...
        html5References.addReference(Opcodes.FSUB, Opcodes.FMUL, "&fjlig;");
        ...
        html5References.addReference(Opcodes.IF_ICMPLT, "&iexcl;");
        html5References.addReference(Opcodes.IF_ICMPLT, "&iexcl");
        html5References.addReference(Opcodes.IF_ICMPGE, "&cent;");
        html5References.addReference(Opcodes.IF_ICMPGE, "&cent");
        html5References.addReference(Opcodes.IF_ICMPGT, "&pound;");
        html5References.addReference(Opcodes.IF_ICMPGT, "&pound");
        html5References.addReference(Opcodes.IF_ICMPLE, "&curren;");
        html5References.addReference(Opcodes.IF_ICMPLE, "&curren");
        html5References.addReference(Opcodes.IF_ACMPEQ, "&yen;");
        html5References.addReference(Opcodes.IF_ACMPEQ, "&yen");
        html5References.addReference(Opcodes.IF_ACMPNE, "&brvbar;");
        html5References.addReference(Opcodes.IF_ACMPNE, "&brvbar");
        ...
        html5References.addReference(Opcodes.RET, "&copy;");
        html5References.addReference(Opcodes.RET, "&copy");
        html5References.addReference(Opcodes.RET, "&COPY");
        html5References.addReference(Opcodes.RET, "&COPY;");
        html5References.addReference(Opcodes.TABLESWITCH, "&ordf;");
        html5References.addReference(Opcodes.TABLESWITCH, "&ordf");
        html5References.addReference(Opcodes.LOOKUPSWITCH, "&laquo;");
        html5References.addReference(Opcodes.LOOKUPSWITCH, "&laquo");
        html5References.addReference(Opcodes.IRETURN, "&not;");
        html5References.addReference(Opcodes.IRETURN, "&not");
        html5References.addReference(Opcodes.LRETURN, "&shy;");
        html5References.addReference(Opcodes.LRETURN, "&shy");
        html5References.addReference(Opcodes.FRETURN, "&reg;");
        html5References.addReference(Opcodes.FRETURN, "&circledR;");
        html5References.addReference(Opcodes.FRETURN, "&reg");
        html5References.addReference(Opcodes.FRETURN, "&REG");
        html5References.addReference(Opcodes.FRETURN, "&REG;");
        html5References.addReference(Opcodes.DRETURN, "&macr;");
        html5References.addReference(Opcodes.DRETURN, "&macr");
        html5References.addReference(Opcodes.DRETURN, "&strns;");
        html5References.addReference(176, "&deg;");
        html5References.addReference(176, "&deg");
        html5References.addReference(Opcodes.RETURN, "&plusmn;");
        html5References.addReference(Opcodes.RETURN, "&plusmn");
        html5References.addReference(Opcodes.RETURN, "&pm;");
        html5References.addReference(Opcodes.RETURN, "&PlusMinus;");
        html5References.addReference(Opcodes.GETSTATIC, "&sup2;");
        html5References.addReference(Opcodes.GETSTATIC, "&sup2");
        html5References.addReference(Opcodes.PUTSTATIC, "&sup3;");
        html5References.addReference(Opcodes.PUTSTATIC, "&sup3");
        html5References.addReference(Opcodes.GETFIELD, "&acute;");
        html5References.addReference(Opcodes.GETFIELD, "&acute");
        html5References.addReference(Opcodes.GETFIELD, "&DiacriticalAcute;");
        html5References.addReference(Opcodes.PUTFIELD, "&micro;");
        html5References.addReference(Opcodes.PUTFIELD, "&micro");
        html5References.addReference(Opcodes.INVOKEVIRTUAL, "&para;");
        html5References.addReference(Opcodes.INVOKEVIRTUAL, "&para");
        html5References.addReference(Opcodes.INVOKESPECIAL, "&middot;");
        html5References.addReference(Opcodes.INVOKESPECIAL, "&centerdot;");
        html5References.addReference(Opcodes.INVOKESPECIAL, "&middot");
        html5References.addReference(Opcodes.INVOKESPECIAL, "&CenterDot;");
        html5References.addReference(184, "&cedil;");
        html5References.addReference(184, "&cedil");
        html5References.addReference(184, "&Cedilla;");
        html5References.addReference(Opcodes.INVOKEINTERFACE, "&sup1;");
        html5References.addReference(Opcodes.INVOKEINTERFACE, "&sup1");
        html5References.addReference(Opcodes.INVOKEDYNAMIC, "&ordm;");
        html5References.addReference(Opcodes.INVOKEDYNAMIC, "&ordm");
        html5References.addReference(Opcodes.NEW, "&raquo;");
        html5References.addReference(Opcodes.NEW, "&raquo");
        html5References.addReference(Opcodes.NEWARRAY, "&frac14;");
        html5References.addReference(Opcodes.NEWARRAY, "&frac14");
        html5References.addReference(Opcodes.ANEWARRAY, "&frac12;");
        html5References.addReference(Opcodes.ANEWARRAY, "&frac12");
        html5References.addReference(Opcodes.ANEWARRAY, "&half;");
        html5References.addReference(Opcodes.ARRAYLENGTH, "&frac34;");
        html5References.addReference(Opcodes.ARRAYLENGTH, "&frac34");
        html5References.addReference(Opcodes.ATHROW, "&iquest;");
        html5References.addReference(Opcodes.ATHROW, "&iquest");
        html5References.addReference(Opcodes.CHECKCAST, "&Agrave;");
        html5References.addReference(Opcodes.CHECKCAST, "&Agrave");
        html5References.addReference(Opcodes.INSTANCEOF, "&Aacute;");
        html5References.addReference(Opcodes.INSTANCEOF, "&Aacute");
        html5References.addReference(Opcodes.MONITORENTER, "&Acirc;");
        html5References.addReference(Opcodes.MONITORENTER, "&Acirc");
        html5References.addReference(Opcodes.MONITOREXIT, "&Atilde;");
        html5References.addReference(Opcodes.MONITOREXIT, "&Atilde");
        html5References.addReference(196, "&Auml;");
        html5References.addReference(196, "&Auml");
        html5References.addReference(Opcodes.MULTIANEWARRAY, "&Aring;");
        html5References.addReference(Opcodes.MULTIANEWARRAY, "&angst;");
        html5References.addReference(Opcodes.MULTIANEWARRAY, "&Aring");
        html5References.addReference(Opcodes.IFNULL, "&AElig;");
        html5References.addReference(Opcodes.IFNULL, "&AElig");
        html5References.addReference(Opcodes.IFNONNULL, "&Ccedil;");
        html5References.addReference(Opcodes.IFNONNULL, "&Ccedil");
        ...
        html5References.addReference(202, "&Ecirc");
        html5References.addReference(HttpServletResponse.SC_NON_AUTHORITATIVE_INFORMATION, "&Euml;");
        html5References.addReference(HttpServletResponse.SC_NON_AUTHORITATIVE_INFORMATION, "&Euml");
        html5References.addReference(204, "&Igrave;");
        html5References.addReference(204, "&Igrave");
        html5References.addReference(HttpServletResponse.SC_RESET_CONTENT, "&Iacute;");
        html5References.addReference(HttpServletResponse.SC_RESET_CONTENT, "&Iacute");
        html5References.addReference(HttpServletResponse.SC_PARTIAL_CONTENT, "&Icirc;");
        html5References.addReference(HttpServletResponse.SC_PARTIAL_CONTENT, "&Icirc");
        html5References.addReference(WebdavStatus.SC_MULTI_STATUS, "&Iuml;");
        html5References.addReference(WebdavStatus.SC_MULTI_STATUS, "&Iuml");
        ...
        html5References.addReference(249, "&ugrave");
        html5References.addReference(StandardSwitchTagProcessor.PRECEDENCE, "&uacute;");
        html5References.addReference(StandardSwitchTagProcessor.PRECEDENCE, "&uacute");
        ...
        html5References.addReference(SSL.SSL_INFO_CLIENT_M_VERSION, "&amacr;");
        html5References.addReference(SSL.SSL_INFO_CLIENT_M_SERIAL, "&Abreve;");
        html5References.addReference(SSL.SSL_INFO_CLIENT_V_START, "&abreve;");
        html5References.addReference(SSL.SSL_INFO_CLIENT_V_END, "&Aogon;");
        html5References.addReference(SSL.SSL_INFO_CLIENT_A_SIG, "&aogon;");
        html5References.addReference(SSL.SSL_INFO_CLIENT_A_KEY, "&Cacute;");
        html5References.addReference(SSL.SSL_INFO_CLIENT_CERT, "&cacute;");
        html5References.addReference(SSL.SSL_INFO_CLIENT_V_REMAIN, "&Ccirc;");
        ...
        html5References.addReference(StandardCaseTagProcessor.PRECEDENCE, "&emacr;");
        ...
        html5References.addReference(HttpServletResponse.SC_PAYMENT_REQUIRED, "&fnof;");
        ...
        html5References.addReference(Status.TIMEUP, "&lscr;");
        html5References.addReference(Status.EAGAIN, "&mscr;");
        html5References.addReference(Status.EINTR, "&nscr;");
        html5References.addReference(Status.ETIMEDOUT, "&pscr;");
