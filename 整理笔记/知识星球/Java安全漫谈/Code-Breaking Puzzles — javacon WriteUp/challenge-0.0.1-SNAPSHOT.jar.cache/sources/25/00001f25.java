...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-expression-5.1.2.RELEASE.jar:org/springframework/expression/spel/SpelMessage.class */
public enum SpelMessage {
    ...
    TYPE_NOT_FOUND(Kind.ERROR, SpringOptionInSelectFieldTagProcessor.ATTR_PRECEDENCE, "Type cannot be found ''{0}''"),
    ...
    PROPERTY_OR_FIELD_NOT_WRITABLE(Kind.ERROR, SpringValueTagProcessor.ATTR_PRECEDENCE, "Property or field ''{0}'' cannot be set on object of type ''{1}'' - maybe not public or not writable?"),
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-expression-5.1.2.RELEASE.jar:org/springframework/expression/spel/SpelMessage$Kind.class */
    public enum Kind {
        INFO,
        WARNING,
        ERROR
