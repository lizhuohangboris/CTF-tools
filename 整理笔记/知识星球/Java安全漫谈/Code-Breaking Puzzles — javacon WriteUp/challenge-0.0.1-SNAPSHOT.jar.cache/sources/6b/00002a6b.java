...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/Yaml.class */
public class Yaml {
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/Yaml$SilentEmitter.class */
    ...
    public <T> T load(InputStream io2) {
        return (T) loadFromReader(new StreamReader(new UnicodeReader(io2)), Object.class);
    }

    public <T> T load(Reader io2) {
        return (T) loadFromReader(new StreamReader(io2), Object.class);
    }

    public <T> T loadAs(Reader io2, Class<T> type) {
        return (T) loadFromReader(new StreamReader(io2), type);
    }
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/Yaml$YamlIterable.class */
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/Yaml$NodeIterable.class */
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/Yaml$EventIterable.class */
