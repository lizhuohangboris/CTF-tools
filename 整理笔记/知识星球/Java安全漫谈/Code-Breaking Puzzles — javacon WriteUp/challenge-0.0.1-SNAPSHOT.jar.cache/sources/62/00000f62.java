...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/hibernate-validator-6.0.13.Final.jar:org/hibernate/validator/constraintvalidators/RegexpURLValidator.class */
public class RegexpURLValidator implements ConstraintValidator<URL, CharSequence> {
    ...
    public boolean isValid(CharSequence value, ConstraintValidatorContext constraintValidatorContext) {
        ...
        if (values == null || !DomainNameUtil.isValidDomainAddress(values.getHost())) {
            return false;
        }
        ...
        if (this.port != -1 && values.getPort() != this.port) {
            return false;
        }
        return true;
    }
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/hibernate-validator-6.0.13.Final.jar:org/hibernate/validator/constraintvalidators/RegexpURLValidator$ValueHolder.class */
