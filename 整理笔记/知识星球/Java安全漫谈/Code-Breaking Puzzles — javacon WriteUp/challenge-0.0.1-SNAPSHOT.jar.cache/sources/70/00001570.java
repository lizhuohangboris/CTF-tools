...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.0.RELEASE.jar:org/springframework/boot/autoconfigure/batch/JobLauncherCommandLineRunner.class */
public class JobLauncherCommandLineRunner implements CommandLineRunner, Ordered, ApplicationEventPublisherAware {
    ...
    public JobLauncherCommandLineRunner(JobLauncher jobLauncher, JobExplorer jobExplorer) {
        ...
        this.jobs = Collections.emptySet();
        this.order = 0;
