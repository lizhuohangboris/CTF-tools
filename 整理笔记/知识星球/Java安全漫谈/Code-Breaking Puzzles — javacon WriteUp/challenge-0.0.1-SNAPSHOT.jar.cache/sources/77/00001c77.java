...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/cglib/util/ParallelSorterEmitter.class */
class ParallelSorterEmitter extends ClassEmitter {
    ...
    public ParallelSorterEmitter(ClassVisitor v, String className, Object[] arrays) {
        super(v);
        begin_class(46, 1, className, PARALLEL_SORTER, null, Constants.SOURCE_FILE);
