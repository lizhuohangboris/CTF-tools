...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/jackson-databind-2.9.7.jar:com/fasterxml/jackson/databind/ser/PropertyWriter.class */
public abstract class PropertyWriter extends ConcreteBeanPropertyBase implements Serializable {
    ...
    public <A extends Annotation> A findAnnotation(Class<A> acls) {
        Annotation annotation = getAnnotation(acls);
        if (annotation == null) {
            annotation = getContextAnnotation(acls);
        }
        return (A) annotation;
    }
}