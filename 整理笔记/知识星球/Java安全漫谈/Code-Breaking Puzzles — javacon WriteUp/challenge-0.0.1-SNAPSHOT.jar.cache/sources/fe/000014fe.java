...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.1.0.RELEASE.jar:org/springframework/boot/ResourceBanner.class */
public class ResourceBanner implements Banner {
    ...
    private PropertyResolver getVersionResolver(Class<?> sourceClass) {
        ...
        propertySources.addLast(new MapPropertySource(XMLDeclaration.ATTRIBUTE_NAME_VERSION, getVersionsMap(sourceClass)));
