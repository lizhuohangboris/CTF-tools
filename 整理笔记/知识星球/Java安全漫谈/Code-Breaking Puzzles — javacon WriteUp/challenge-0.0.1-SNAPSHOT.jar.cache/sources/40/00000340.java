...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/jackson-databind-2.9.7.jar:com/fasterxml/jackson/databind/cfg/BaseSettings.class */
public final class BaseSettings implements Serializable {
    ...
    public BaseSettings with(TimeZone tz) {
        ...
        DateFormat df = _force(this._dateFormat, tz);
