...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.1.2.RELEASE.jar:org/springframework/core/codec/AbstractSingleValueEncoder.class */
public abstract class AbstractSingleValueEncoder<T> extends AbstractEncoder<T> {
    ...
    public final Flux<DataBuffer> encode(Publisher<? extends T> inputStream, DataBufferFactory bufferFactory, ResolvableType elementType, @Nullable MimeType mimeType, @Nullable Map<String, Object> hints) {
        return Flux.from(inputStream).take(1L).concatMap(t -> {
            return encode((AbstractSingleValueEncoder<T>) t, bufferFactory, elementType, mimeType, (Map<String, Object>) hints);
        });
    }
}