...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.1.0.RELEASE.jar:org/springframework/boot/web/server/MimeMappings.class */
public final class MimeMappings implements Iterable<Mapping> {
    ...
    static {
        ...
        mappings.add(StandardRemoveTagProcessor.VALUE_BODY, "text/html");
        ...
        mappings.add(DocType.DEFAULT_ELEMENT_NAME, "text/html");
        ...
        mappings.add(XMLDeclaration.DEFAULT_KEYWORD, "application/xml");
    ...
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.1.0.RELEASE.jar:org/springframework/boot/web/server/MimeMappings$Mapping.class */
