...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/attoparser-2.0.5.RELEASE.jar:org/attoparser/HtmlVoidAutoCloseElement.class */
public class HtmlVoidAutoCloseElement extends HtmlVoidElement {
    ...
    public HtmlVoidAutoCloseElement(String name, String[] autoCloseElements, String[] autoCloseLimits) {
        super(name);
