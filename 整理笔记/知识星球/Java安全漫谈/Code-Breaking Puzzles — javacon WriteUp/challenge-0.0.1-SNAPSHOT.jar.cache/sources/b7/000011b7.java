...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/hibernate-validator-6.0.13.Final.jar:org/hibernate/validator/internal/xml/mapping/ClassConstraintTypeStaxBuilder.class */
public class ClassConstraintTypeStaxBuilder extends AbstractStaxBuilder {
    ...
    public ConstrainedType build(Class<?> beanClass) {
        ...
        Set<MetaConstraint<?>> metaConstraints = (Set) this.constraintTypeStaxBuilders.stream().map(builder -> {
            return builder.build(constraintLocation, ElementType.TYPE, null);
        }).collect(Collectors.toSet());
        if (this.ignoreAnnotations.isPresent()) {
            this.annotationProcessingOptions.ignoreClassLevelConstraintAnnotations(beanClass, this.ignoreAnnotations.get().booleanValue());
        }
        return new ConstrainedType(ConfigurationSource.XML, beanClass, metaConstraints);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/hibernate-validator-6.0.13.Final.jar:org/hibernate/validator/internal/xml/mapping/ClassConstraintTypeStaxBuilder$GroupSequenceStaxBuilder.class */
    public static class GroupSequenceStaxBuilder extends AbstractMultiValuedElementStaxBuilder {
