...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/thymeleaf-3.0.11.RELEASE.jar:org/thymeleaf/standard/expression/NotEqualsExpression.class */
public final class NotEqualsExpression extends EqualsNotEqualsExpression {
    ...
    public static Object executeNotEquals(IExpressionContext context, NotEqualsExpression expression, StandardExpressionExecutionContext expContext) {
        Boolean result;
        ...
        if (logger.isTraceEnabled()) {
            logger.trace("[THYMELEAF][{}] Evaluating NOT EQUALS expression: \"{}\". Left is \"{}\", right is \"{}\". Result is \"{}\"", TemplateEngine.threadIndex(), expression.getStringRepresentation(), leftValue2, rightValue2, result);
        }
        return result;
    }
}