...
/* loaded from: challenge-0.0.1-SNAPSHOT.jar:BOOT-INF/lib/hibernate-validator-6.0.13.Final.jar:org/hibernate/validator/internal/engine/path/NodeImpl.class */
public class NodeImpl implements Path.PropertyNode, Path.MethodNode, Path.ConstructorNode, Path.BeanNode, Path.ParameterNode, Path.ReturnValueNode, Path.CrossParameterNode, Path.ContainerElementNode, PropertyNode, ContainerElementNode, Serializable {
    ...
    public static NodeImpl createParameterNode(String name, NodeImpl parent, int parameterIndex) {
        return new NodeImpl(name, parent, false, null, null, ElementKind.PARAMETER, EMPTY_CLASS_ARRAY, Integer.valueOf(parameterIndex), null, null, null);
    }
    ...
    public <T extends Path.Node> T as(Class<T> nodeType) {
        ...
        throw LOG.getUnableToNarrowNodeTypeException(getClass(), this.kind, nodeType);
    }
    ...
    private String buildToString() {
        ...
        if (includeTypeParameterInformation(this.containerClass, this.typeArgumentIndex)) {
            ...
            builder.append(TypeVariables.getTypeParameterName(this.containerClass, this.typeArgumentIndex.intValue()));
    ...
    private static boolean includeTypeParameterInformation(Class<?> containerClass, Integer typeArgumentIndex) {
        if (containerClass == null || typeArgumentIndex == null || containerClass.getTypeParameters().length < 2) {
            return false;
        }
        if (Map.class.isAssignableFrom(containerClass) && typeArgumentIndex.intValue() == 1) {
            return false;
        }
        return true;
    }
